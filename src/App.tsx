...
function App() {
  return (
    <>
      <Text type='h1'>Morbi interdum mollis sapien</Text>
      <Text type='h2'>Morbi interdum mollis sapien</Text>
      <Text type='h3'>Morbi interdum mollis sapien</Text>
      <Text type='h4'>Morbi interdum mollis sapien</Text>
      <Text type='h5'>Morbi interdum mollis sapien</Text>
      <Text type='h6'>Morbi interdum mollis sapien</Text>
      <Text type='overline'>Lorem ipsum</Text>
      <Text type='sub_title'>Fusce ut est sed dolor gravida convallis</Text>
      <Text type='body'>
        ...
        vel lacus. Mauris nibh felis, adipiscing varius, adipiscing in, lacinia
        vel, tellus. Suspendisse ac urna. Etiam pellentesque mauris ut lectus.
        Nunc tellus ante, mattis eget, gravida vitae, ultricies ac, leo. Integer
        leo pede, ornare a, lacinia eu, vulputate vel, nisl. Suspendisse mauris.
        ...
        Vivamus imperdiet nibh feugiat est. Ut convallis, sem sit amet interdum
        ...
        Suspendisse laoreet. Fusce ut est sed dolor gravida convallis.
      </Text>
    </>
  )
}
