...
import { ProductData } from '../config/dataTypes'
...
export const AppData = createContext<ProductData | null>(null)
...
export function useProductDataContext() {
  ...
  if (!context)
    throw new Error(
      'ProductDataContext must be used within a ProductDataContext provider'
    )
  return context
}
